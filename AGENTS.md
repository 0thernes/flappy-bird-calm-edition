...
- There is nothing to install: the project has zero runtime and dev dependencies, no `node_modules`, and no build step. Node 18+ is all that is needed for the checks.
